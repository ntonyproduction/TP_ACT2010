...
On constate que $\lambda = 0.1$ semble être l'estimé MLE situé au centre de l'intervalle de confiance 95%, soit $]-0.5, 0.7[$. Puisque $\lambda = 0$ est dans notre IC, le paramètre peut également être une valeur à considérer. Donc, on utilise la transformée logarithmique pour notre modèle.
