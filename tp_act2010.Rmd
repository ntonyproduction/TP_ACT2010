...
$$
Il est important de noter que, puisqu'une transformation logarithmique a été effectuée sur les données du taux de change US/Euro, le prédicicteur de $Y_t$, $\hat{Y}_t(l)$, sera tel que;
...
\newpage
```{r fig1.13, eval=T, echo=F,fig.height=3.2, warning=F}
...
```{r fig1.14, eval=T, echo=F,fig.height=4.9, warning=F}
