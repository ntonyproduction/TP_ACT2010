...
```{r fig2.9, echo=F, out.width='.49\\linewidth', fig.height=5, fig.align="left", fig.show='hold',fig.align='center', warning=F}
# histogrammes
...
```{r fig2.10, eval=T, echo=F, fig.height=5, fig.width=2.3, fig.show='hold', fig.align='center', warning=F}
...
```{r fig110, eval=T, echo=F, fig.height=3.3, fig.width=2.3, fig.show='hold', fig.align='center'}
...
```{r npa2, echo=F, out.width='.49\\linewidth', fig.height=5, fig.align="left", fig.show='hold',fig.align='center', warning=F}
...
```{r npa5, eval=T, echo=F, fig.height=4.1, warning=F}
tsdiag(ttaux011, gof=15, omit.inital=F)
```
\textbf{Figure ??} Graphiques des résidus standardisés, de l'autocorrélation des résidus et des p-values du test de Ljung-Box du modèle ARIMA(0,1,0) pour le l'inverse de la différence de NPA.

```{r fig111, eval=T, echo=F, fig.height=4.1, warning=F}
tsdiag(ttaux110, gof=15, omit.inital=F)
```
\textbf{Figure ??} Graphiques des résidus standardisés, de l'autocorrélation des résidus et des p-values du test de Ljung-Box du modèle ARIMA(0,1,1) pour le l'inverse de la différence de NPA.\newline\newline
...
```{r fig114, eval=T, echo=F, fig.height=5, fig.width=2.3, fig.show='hold', fig.align='center', warning=F}
...
```{r fig2.11, eval=T, echo=F, fig.height=3.3, fig.show='hold', fig.align='center'}
...
```{r fig2.17, eval=T, echo=F, fig.height=3.3, fig.show='hold', fig.align='center'}
