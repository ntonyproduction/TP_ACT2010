...
```{r fig2.6.1, echo=F, out.width='.49\\linewidth', fig.height=5, fig.align="left", fig.show='hold',fig.align='center', warning=F}
# graphiques des EACF
eacf(diff(naadc^-1), ar.max=5,ma.max=10)
eacf(diff(npa^-1), ar.max=5,ma.max=10)
```

```{r fig2.6.2, echo=F, out.width='.49\\linewidth', fig.height=5, fig.align="left", fig.show='hold',fig.align='center', warning=F}
# graphiques des EACF
