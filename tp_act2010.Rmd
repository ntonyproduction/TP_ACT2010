...
\newline\newline
On regarde, pour finaliser le choix de modèle, la question de l'\textit{overfiting}.

tsoutliers = TA BESOIN DE DOWNLOADER LE PACKAGE TSOUTLIERS pour retirer les données aberrantes avec la fonction "tso"


parler de la surparamétrisation. je n'ai pas fait les prévisions du test pcq je veux voir quel modele on prend.

pi les tests de Dickey Fuller, c'est stationnaire quand c est en bas de 5% pour la p-value et non stationnaire dans le cas contraire.
