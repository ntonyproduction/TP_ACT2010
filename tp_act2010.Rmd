...
taux <- read.csv2("Taux_de_change_US_Euro.csv")
...
```
\textbf{Figure 16.} Graphiques des différents log de de vraisemblance (NAADC en haut à gauche, NPA en haut à droit, NDI en bas à gauche et CTI en bas à droit).
...
\textbf{Figure 17.} Graphiques des séries chronologiques transformées diférentiées (NAADC en haut à gauche, NPA en haut à droit, NDI en bas à gauche et CTI en bas à droit).
...
```
\textbf{Figure 18.} Graphiques des fonctions d'autocorrélation de nos séries chronologiques transformées diférentiées (NAADC en haut à gauche, NPA en haut à droit, NDI en bas à gauche et CTI en bas à droit).
...
```
\textbf{Figure 19.} Graphiques des fonctions d'autocorrélation partielles de nos séries chronologiques transformées diférentiées (NAADC en haut à gauche, NPA en haut à droit, NDI en bas à gauche et CTI en bas à droit).
...
\textbf{Figure 20.} Graphiques des fonctions d'autocorrélation étendues de nos séries chronologiques transformées diférentiées (NAADC en haut à gauche, NPA en haut à droit, NDI en bas à gauche et CTI en bas à droit).
...
\textbf{Figure 21.} Graphiques des BIC de nos séries chronologiques transformées diférentiées (NAADC en haut à gauche, NPA en haut à droit, NDI en bas à gauche et CTI en bas à droit).
...
```{r fig2.9, echo=F, out.width='.49\\linewidth', fig.height=5.5, fig.width=7, fig.align="left", fig.show='hold',fig.align='center', warning=F}
# histogrammes
...
```{r fig110, eval=T, echo=F, fig.height=5.5, fig.width=3.5, fig.show='hold', warning=F}
tsdiag(naadc000, gof=15, omit.inital=F)
tsdiag(naadc100, gof=15, omit.inital=F)
```

\textbf{Figure 22.} Les trois graphiques à gauche concernent le ARMA(0,0) et les graphiquesde droite concernent l'ARMA(1,0) pour notre NAADC.
...
```{r npa2, echo=F, out.width='.49\\linewidth', fig.height=5.5, fig.width=7.5, fig.show='hold',fig.align='center', warning=F}
plot(rstandard(npa000), ylab = "résidus standardisés", type = "l", col = "blue")
lines(rstandard(npa001), col = "red")
```
\textbf{Figure 23} Superposition des graphiques des résidus standardisés des modèles ARIMA(0,1,0) et ARIMA(0,1,1) du data NPA.\newline\newline
...
```{r npa3, echo=F, out.width='.49\\linewidth', fig.height=5.5, fig.show='hold',fig.align='center', warning=F}
# histogrammes
...
```
\textbf{Figure 24} Histogramme des résudies standardisés des modèles ARIMA(0,1,0) et ARIMA(0,1,1) du data NPA.\newline\newline
...
```{r npa4, eval=T, echo=F, fig.height=4, fig.width=3, fig.show='hold', fig.align='center'}
qqnorm(rstandard(naadc000), main='ARMA(0,0)',ylab='Quantiles observés',xlab='Quantiles théoriques',cex=0.2)
qqnorm(rstandard(naadc100),main='ARMA(1,0)',xlab='Quantiles théoriques', ylab='Quantiles observés',cex=0.2)
```
\textbf{Figure 25} graphique QQ des modèles ARIMA(0,1,0) et ARIMA(0,1,1) \newline\newline
...
```{r npa5, eval=T, echo=F, fig.height=5.5, fig.width=3.5, fig.show='hold', warning=F}
tsdiag(ttaux011, gof=15, omit.inital=F)
tsdiag(ttaux110, gof=15, omit.inital=F)
```
...
```{r fig4.10, eval=T, echo=F, out.width='.49\\linewidth', fig.height=5.5, fig.width=8.5, fig.align="left", fig.show='hold',fig.align='center', warning=F}
# QQ Plot
...
```{r fig1135, eval=T, echo=F, fig.height=5.5, fig.width=3.5, fig.show='hold', warning=F}
tsdiag(ndi000, gof=15, omit.inital=F)
tsdiag(ndi001, gof=15, omit.inital=F)
tsdiag(ndi100, gof=15, omit.inital=F)
```

\textbf{Figure 26} Superposition des graphiques des résidus standardisés des modèles ARIMA(0,1,0) et ARIMA(0,1,1) du data NPA.\newline\newline
...
```{r fig2.12, echo=F, fig.height=4.5}
# graphiques résidus standardisés
...
```{r fig2.13, echo=F, out.width='.49\\linewidth', fig.height=5.5, fig.align="left", fig.show='hold',fig.align='center', warning=F}
# histogrammes
...
```{r fig2.14, eval=T, echo=F, fig.height=4.5, fig.width=3, fig.show='hold'}
...
```{r fig114, eval=T, echo=F, fig.height=5.5, fig.width=3.5, fig.show='hold', warning=F}
tsdiag(cti000, gof=15, omit.inital=F)
tsdiag(cti003, gof=15, omit.inital=F)
```

\textbf{Figure 27} Superposition des graphiques des résidus standardisés des modèles ARIMA(0,1,0) et ARIMA(0,1,3) du data CTI.\newline\newline
