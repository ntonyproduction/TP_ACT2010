...
plot(ttaux,ylab='taux de change US/Euro', type="o")
...
#suggere la non stationnarite avec une p value de 79%
...
#ON CHOISI DONC UN MODELE ARIMA(0,1,1) pour le log de Yt
